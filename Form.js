class Form{
    ...
    display(){
        ...
        title.html("Survey: Your Opinion Matters");
        title.position(310,40);
        ...
        Q1Txt.html("Q1.Do You think that our teachers should teach us practically?");
        Q1Txt.position(130,250);
        var ans1 = createInput("");
        ans1.position(130,315);

        var Q2Txt = createElement('h3');
        Q2Txt.html("Q2.Do You think that our teachers should teach us in open ground?");
        Q2Txt.position(130,335);
        var ans2 = createInput("");
        ans2.position(130,395);

        var Q3Txt = createElement('h3');
        Q3Txt.html("Q3. Do you like the measures taken by your school in this Lockdown?");
     ...
     button.mousePressed(function(){
         background("lightblue");
            ...
            alert("Thankyou,for your valuable response! We appreciate it!");
            ...
            msg.html("Your Response is succesfully submitted!!");
